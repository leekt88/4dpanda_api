...
if(!isset($data->STC) && !isset($data->SCS) && !isset($data->SB) && !isset($data->SBLT)) return;
?>
        <div class="west-content">             
            ...
            <div class="col-xs-12 resultprizelable  section-header gn_aac_18">
                <span>
                    <?= isset($headings['heading_3'])?$headings['heading_3']:'Sabah Sarawak 4D Results';?>
                </span>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_19">
                <div class="result outerbox st">
                    ...
                    <table class="resultView2" style="height:163px ;">
                        <tbody>
                            <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="height:498px;">
                                        <?php if(isset($ads['ads_position_3'])):?>
                                            <?= $ads['ads_position_3'];?>
                                        <?php else:?>
                                            Adverstisement 3(ads_position_3)
                                        <?php endif;?>
                                    </td>
                                </tr>
                            </tbody>

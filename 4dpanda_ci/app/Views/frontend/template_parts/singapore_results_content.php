...
if(!isset($data->SGP4D) && !isset($data->SGPTT)) return;
?> 
        <div class="singapore-content">            
            ...
            <div class="col-xs-12 resultprizelable gn_aac_12  section-header">
                <span>
                    <?= isset($headings['heading_2'])?$headings['heading_2']:'Singapore 4D Results';?>
                </span>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_13">
                <div class="result outerbox sg4d">
                    ...
                    <table class="resultView2">
                        <tbody>
                            <tr>
                                <td class="resultviewbottom" style="height:25x;">4DPANDA.COM</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <?php if(!isset($api)):?>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_14">
                <div class="outerbox sg4d">
                    <table class="resultView2" style="height:394px;">
                        <tbody>
                            <tr>
                                <td colspan="8" class="resultprizelable">
                                    <?php if(isset($ads['ads_position_2'])):?>
                                        <?= $ads['ads_position_2'];?>
                                    <?php else:?>
                                        Adverstisement 2
                                    <?php endif;?>

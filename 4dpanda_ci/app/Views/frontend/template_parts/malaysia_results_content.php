...
if(!isset($data->M4D)&&!isset($data->DMC4D)&&!isset($data->TT)) return;
?>
        <div class="malaysia-content">          
            <div class="col-xs-12 gn_aac_1">
                ...
                <div class="col-xs-12 resultprizelable  section-header">
                    <span>
                        <?= isset($headings['heading_1'])?$headings['heading_1']:'Malaysia 4D Results';?>
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_2">
                <div class="result outerbox magnum">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="result5dprizelable"><b id="mjp1"><?=$data->M4D->JP1?></b><br><span class="blink"
                                        id="mjp1won"><?=($data->M4D->JP1WON >=2)?"Won": "Partially Won";?></span></td>
                                <td class="result5dprizelable"><b id="mjp2"><?=$data->M4D->JP2?></b><br><span class="blink"
                                        id="mjp2won"><?=($data->M4D->JP2WON >=2)?"Won": "Partially Won";?></span></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="resultView2">
                    ...
                    <table class="resultView2 ">
                        <tbody>
                            <tr>
                                <td class="result5dprizelable" style="height:57px;">4DPANDA.COM</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="result outerbox damacai">
                    ...
                    <table class="resultView2">
                        <tbody>
                            ...
                            <tr>
                                <td class="result5dprizelable"><b id="djp1"><?=$data->DMC4D->JP1?></b>
                                    <br><span class="blink" id="djp1won"><?=($data->DMC4D->JP1WON >=1)?"Won": "Partially Won";?></span>
                                </td> 
                                <td class="result5dprizelable"><b id="djp2"><?=$data->DMC4D->JP2?></b>
                                <br><span class="blink" id="djp2won"><?=($data->DMC4D->JP2WON >=1)?"Won": "Partially Won";?></span></td>
                            </tr> 
                            <tr> 
                                <td class="resultprizelable">3D Jackpot Prize</td> 
                                <td class="result5dprizelable" style="background-color:#eee">
                                    <b id="djp3"><?=$data->DMC4D->JP3?></b><span class="blink" id="djp3won"></span>
                                </td> 
                            </tr> 
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="result5dprizelable">
                                    <b id="destjp1"><?=$data->DMC4D->EJP1?></b>
                                </td> 
                                <td class="result5dprizelable">
                                    <b id="destjp2"><?=$data->DMC4D->EJP2?></b>
                                </td>
                            </tr> 
                            <tr> 
                                <td class="resultprizelable">3D Jackpot Prize

                                </td> 
                                <td class="result5dprizelable" style="background-color:#eee">
                                    <b id="destjp3"><?=$data->DMC4D->EJP3?></b>
                                </td> 
                            </tr> 
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="height:15px;">
                                    <?php if(isset($ads['ads_position_0'])):?>
                                        <?= $ads['ads_position_0'];?>
                                    <?php else:?>
                                        Adverstisement 0 (ads_position_0)
                                    <?php endif;?>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_8"> 
                <div class="outerbox toto">
                    ...
                    <table class="resultView2 headname">
                        <tbody>
                            <tr>
                                <td class="resultdrawdate" id="ttdd" style="text-align:right"><?=$data->TT->DD?></td>
                                <td class="resultdrawdate" id="ttdn"><?=$data->TT->DN?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="resultView2">
                        ...
                        <tbody>
                            <tr>
                                <td style="height:94px;">
                                    <?php if(isset($ads['ads_position_1'])):?>
                                        <?= $ads['ads_position_1'];?>
                                    <?php else:?>
                                        Advertisement 1 (ads_position_1)
                                    <?php endif;?>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="outerbox magnum">
                    <table class="resultTable" align="center">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="10" class="result5dprizelable">Prize : <b><?=$data->M4DJG->JP1;?></b>
                                <span class="blink">
                            ...
                            <tr>
                                <td colspan="10" class="result5dprizelable">Prize : <b><?=$data->M4DJG->JP2;?></b><span class="blink">

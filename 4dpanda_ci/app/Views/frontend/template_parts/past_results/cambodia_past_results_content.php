...
if(!isset($data->GD) && !isset($data->P4D1) && !isset($data->P4D2) && !isset($data->H4D6D1) && !isset($data->H4D6D2) && !isset($data->GD) &&!isset($data->NLT)) continue;
?>   
        <div class="cambodia-content">          
            ...
            <div class="col-xs-12 resultprizelable gn_aac_24 section-header">
                <span>
                    <h2>Past <?= isset($headings['heading_4'])?strip_tags($headings['heading_4']):'Cambodia 4D Results';?>: <?php echo date("d-m-Y (D)", strtotime($data->date));?></h2>
                </span>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xxs-12 gn_aac_27">
                <div class="outerbox camh">
                    ...
                    <table class="resultView2">
                        <tbody>
                            <tr>
                                <td class="resultviewbottom" style="height:143px;">4DPANDA.COM</td>
                            </tr>
                        </tbody>
                    </table>      
                </div>

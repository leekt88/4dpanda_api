...
if(!isset($data->LMC1)&&!isset($data->LMC)&&!isset($data->MTH)) continue;
...
?>   
        <div class="cambodia-content">          
            ...
            <div class="col-xs-12 resultprizelable gn_aac_24 section-header">
                <span>
                 <h2>Past <?= isset($headings['heading_5'])?strip_tags($headings['heading_5']):'Other Lottery 4D Results';?>: <?php echo date("d-m-Y (D)", strtotime($data->date));?></h2>
                </span>
            </div>
